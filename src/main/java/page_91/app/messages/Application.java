...
public class Application {
    public static void main(String[] args) {
        ...
        // 사용자가 정의한 @Bean 네임을 이용하여 불러올 수 있다
        MessageService beanNameMessageService = (MessageService) context.getBean("customMessageService");
        beanNameMessageService.save("Hell, Bean Name");
    }
}
